#include "sycl_points_ros2/graph_odometry_node.hpp"
...
GraphOdometryNode::GraphOdometryNode(const rclcpp::NodeOptions& options)
    : GraphOdometryBaseNode("graph_odometry", options) {
    ...
    sub_pc_ = this->create_subscription<sensor_msgs::msg::PointCloud2>(
        ...
        std::bind(&GraphOdometryNode::point_cloud_callback, this, std::placeholders::_1), lidar_opts);
    ...
    if (this->params_.imu.enable) {
        ...
        sub_imu_ = this->create_subscription<sensor_msgs::msg::Imu>(
            ...
            std::bind(&GraphOdometryNode::imu_callback, this, std::placeholders::_1), imu_opts);
...
void GraphOdometryNode::point_cloud_callback(const sensor_msgs::msg::PointCloud2::UniquePtr msg) {
...
RCLCPP_COMPONENTS_REGISTER_NODE(sycl_points::ros2::GraphOdometryNode)
