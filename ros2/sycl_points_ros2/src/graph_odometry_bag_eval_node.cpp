#include "sycl_points_ros2/graph_odometry_bag_eval_node.hpp"
...
GraphOdometryBagEvalNode::GraphOdometryBagEvalNode(const rclcpp::NodeOptions& options)
    : GraphOdometryBaseNode("graph_odometry_bag_eval", options) {
...
GraphOdometryBagEvalNode::~GraphOdometryBagEvalNode() {
...
void GraphOdometryBagEvalNode::run() {
...
std::string GraphOdometryBagEvalNode::detect_storage_id(const std::string& uri) const {
...
void GraphOdometryBagEvalNode::write_tum_line(const geometry_msgs::msg::PoseStamped& pose_msg) {
...
RCLCPP_COMPONENTS_REGISTER_NODE(sycl_points::ros2::GraphOdometryBagEvalNode)
