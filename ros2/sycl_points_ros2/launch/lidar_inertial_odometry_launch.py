...
def generate_launch_description():
    ...
    node_name = "lidar_inertial_odometry_node"
        ...
        container = TimerAction(
            ...
            actions=[
                ComposableNodeContainer(
                    ...
                    executable="component_container_mt",  # MultiThreadedExecutor (required for concurrent IMU feed)
                    output="screen",
                    emulate_tty=True,
    ...
    rviz = Node(
        package="rviz2",
        executable="rviz2",
        arguments=["-d", os.path.join(package_dir, "rviz2", "rviz2_lio.rviz")],
