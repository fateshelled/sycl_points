...
def generate_launch_description():
    ...
    launch_args.extend(
        [
            ...
            DeclareLaunchArgument('rosbag/start_offset/sec', default_value='0.0', description='bag start offset in seconds'),
        ...
        Node(
            ...
            parameters=[
                node_args,
                {
                    ...
                    'rosbag/start_offset/sec': ParameterValue(LaunchConfiguration('rosbag/start_offset/sec'), value_type=float),
